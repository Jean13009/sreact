...
class Customer
{
     ...
     * @Assert\Length(min=3, minMessage="Le nom doit faire au moins 3 caractères", max=255, maxMessage="Le nom doit faire moins de 255 caractères")
     */
    private $lastName;
    ...
    public function getTotalAmount(): float {
     ...
     /**
     * Permet de récupérer le total des factures dues
     * @Groups({"customers_read"})
     * @return float
     */
