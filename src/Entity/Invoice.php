...
*/
        class Invoice
        {
            ...
            * @Assert\Type(type="numeric", message="Le montant ne doit pas contenir de lettre")
            */
            private $amount;
            ...
            * @Groups({"invoices_read", "customers_read", "invoices_subresource"})
            * @Assert\NotBlank(message="Statut de la facture obligatoire")
            * @Assert\Choice(choices={"SENT", "PAID", "CANCELLED"}, message="Statut SENT PAID ou CANCELLED")
            */
            private $status;
            ...
            */
            ...
            /**
             * Récupère l'user à qui appartient la facture
